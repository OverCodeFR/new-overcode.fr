...
export default function AboutSection() {
    return (
        <div className="bg-white py-24 sm:py-32" id="a-propos">
                ...
                <div className="mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                    ...
                    <div>
                        <div className="text-base/7 text-gray-700 lg:max-w-lg">
                            <h2 className="text-base/7 font-semibold text-secondary">A propos</h2>
                            <div className="mt-2 text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">
